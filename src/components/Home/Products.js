  ...
  return (
    <div className="mt-6">
      ...
      <div className="w-full sm:w-[95%] h-fit bg-white sm:bg-[#f5f5fa] mx-auto  p-5 rounded-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-6 gap-x-8 justify-items-center">
          {data?.map((data, i) => {
            if (data.productType === "shirt") {
              return (
                <div
                  className="p-2 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-[170px] sm:w-[250px] hover:shadow-lg"
                  key={i}
                >
                  <div className="w-full flex justify-center items-center">
                    <div className="w-[150px] h-[160px] sm:w-[250px] sm:h-[200px] overflow-hidden">
                      <img
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-items-center">
          {data?.map((data, i) => {
            if (data.productType === "pant") {
              return (
                <div
                  className="p-2  overflow-hidden max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-[170px] sm:w-[250px] hover:shadow-lg"
                  key={i}
                >
                  <div className="w-full flex justify-center items-center">
                    <div className="w-[150px] h-[160px] sm:w-[250px] sm:h-[200px] overflow-hidden">
